...
<template>
  <div class="w-full md:w-5/12 mt-4 mr-4">
    <div class="bg-white p-3 rounded-lg shadow-lg">
      ...
      <div class="pb-5">
        <button
          class="w-full bg-gray-200 hover:bg-gray-300 rounded-lg p-2 font-medium text-sm text-[#050505]"
        >
          Thêm tiểu sử
        </button>
      </div>
        ...
        >
          <Image
            ...
            :pt="{
              ...
              image: {
                class:
                  'cursor-pointer border-white border-4 border-white aspect-square object-cover rounded-lg cursor-pointer'
              }
            }"
          />
        </router-link>
