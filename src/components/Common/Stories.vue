    ...
    <div class="flex flex-row items-center justify-start space-x-2 w-full overflow-y-hidden">
      <div class="flex w-[160px] h-[250px] rounded-xl drop-shadow-md">
        <div class="relative h-[180px] ">
          <img :src="user.photoURL" class="w-[160px] h-[180px] object-cover overflow-clip text-ellipsis rounded-t-xl" />
          <div
          ...
          <div class="flex items-center justify-center my-auto flex-grow h-[70px] bg-white rounded-b-lg">
