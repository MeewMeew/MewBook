...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 112 112" :width="props.size" :height="props.size">
    <defs>
      <clipPath id="a">
    ...
    <path fill="#7a7d81" d="M27.37 17.56h11.3a3.84 3.84 0 013.84 3.84v15h-19v-15a3.84 3.84 0 013.86-3.84z" />
    ...
    <path fill="#7a7d81" d="M68.63 68.28h5.06A26.12 26.12 0 0199.8 94.4v5.25H42.51V94.4a26.12 26.12 0 0126.12-26.12z" />
