...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 16 16" width="18"
    height="18">
    <defs>
    <linearGradient id="a" x1="50%" x2="50%" y1="0%" y2="100%">
      <stop offset="0%" stop-color="%2318AFFF"></stop>
      <stop offset="100%" stop-color="%230062DF"></stop>
    </linearGradient>
  ...
  <g fill="none">
    <use fill="url(%23a)" xlink:href="%23b"></use>
    <use fill="black" filter="url(%23c)" xlink:href="%23b"></use>
    <path fill="white"
