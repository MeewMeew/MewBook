...
<template>
  <div v-if="props.content" class="px-5 pb-2 text-[17px] font-medium" v-html="formatContent(props.content)"></div>
    <div class="w-full">
      <div :class="['object-fill w-full bg-no-repeat backdrop-blur-md bg-white/30']"
      ...
      >
        ...
        <router-link v-else :to="{ name: 'post', params: { id } }" class="object-cover flex items-center justify-center">
